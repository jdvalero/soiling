	...
	if(isset($_SESSION['id'])){
	  header('location: inicio/controller/redirec.php');
	}
	...
	<body>
		...
		<div class="wrapper1">
			...
			<ul class="menu">
			 ...
			 <li><a href="inicio y Registro/registrar.php">Registrate</a></li>
			 <li><a href="inicio y Registro/index.php">Iniciar Sesion</a></li>
...
<section class="fondo">
	...
	<br>
<h3>Bienvenidos</h3>
<hr width="1345" color="white">
<h6>
Geotécnica, Túneles y Obras de Infraestructura.<br>

Somos un equipo de ingenieros especializados en geotécnica y túneles.</h6>

<center>
<button class="button1"><a href="#abajo">Ver mas ...</a>
